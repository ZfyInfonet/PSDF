...
def change_VNF_priority(state: State):
    ...
    VNF_priority = [vnf.get_vnf_ID() for vnf in vnf_list]
    random.shuffle(VNF_priority)
    return VNF_priority
    ...
    for eps in range(episode):
        ...
        for time_slot in range(training_stop_time):
            ...
            for i in Priority:
                ...
                result_1 = t1.get_result()  # output_list
                result_2 = t2.get_result()
                result_3 = t3.get_result()
                result_4 = t4.get_result()

                list_1 = [result_1[0], result_1[4], result_1[3]]
                list_2 = [result_2[0], result_2[4], result_2[3]]
                list_3 = [result_3[0], result_3[4], result_3[3]]
                list_4 = [result_4[0], result_4[4], result_4[3]]
        ...
        cost.to_csv('./result/PSDF_II_rd_result_PN' + str(PN_num) + '_VN' +
